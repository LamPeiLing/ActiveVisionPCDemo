...
class CourtReference:
    ...
    def __init__(self):
        ...
        court_path = os.path.join(os.path.dirname(__file__), "court_configurations/court_reference.png")
    ...
    def build_court_reference(self):
        ...
        court_path = os.path.join(os.path.dirname(__file__), "court_configurations/court_reference.png")
        plt.imsave(court_path, court, cmap='gray')
        self.court = court
        return court
    ...
    def save_all_court_configurations(self):
        ...
        for i, conf in self.court_conf.items():
            ...
            cv2.imwrite(f'{os.path.join(os.path.dirname(__file__))}/court_configurations/court_conf_{i}.png', c)
